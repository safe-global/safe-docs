...
the following to signal that the dApp wants to use off-chain signing:
...
Now we can query the state of the message from the tx-service's endpoint for messages: https://safe-transaction-goerli.staging.5afe.dev/api/messages/<SafeMsgHash>
