...
[Scaffold-ETH Safe Starter Kit](https://github.com/scaffold-eth/scaffold-eth/tree/gnosis-starter-kit) is a fork of the Scaffold-ETH framework integrated with the [Safe Core SDK](safe-protocol-kit-safe-core-sdk/core-sdk.md) to allow for the rapid prototyping of new UIs and user experiences.
