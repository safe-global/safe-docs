...
1. Preferified transaction hash signatures

For more information check on how the signature types and how to generate and encode the see [Signatures](./signatures.html).
