...
Add (or edit) a new wallet to the configuration, so they can be attributed to chains. This will enable the use of these wallets for these chains on (Web3 Onboard)(https://onboard.blocknative.com/docs/overview/introduction).
