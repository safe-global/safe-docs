...
Safe APIs currently enforce rate limits of 5 requests/sec based on your tier. If you need higher rate limits, please reach out to us at support@safe.global for details on upgrading your tier and understanding usage quotas.
