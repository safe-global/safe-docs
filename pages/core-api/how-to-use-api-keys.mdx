...
⚠️ **Important:** We plan to deprecate public (unauthenticated) endpoints in the near future. We strongly encourage you to transition to authenticated API access now to avoid disruptions to your integration.
...
## ⚖️ Rate Limits and Usage Tiers

Safe APIs currently enforce rate limits of 5requests/sec  based on your tier. If you need higher rate limits, please reach out to us at support@safe.global for details on upgrading your tier and understanding usage quotas.
