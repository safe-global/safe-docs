...
*Safe* is a battle-tested Account Abstraction framework built with security in its core securing $100B+ digital assets across 10M+ accounts and provides the Web3 standard for digital ownership through modular account abstraction

Safe\{Stack\} is composed of the following OpenSource components:

![Untitled](../../assets/diagram-safe-stack.png)
...
1. Clone the repository `https://github.com/safe-global/safe-smart-account@<version>` (e.g. `version=v1.3.0-libs.0`).
