...
You can optionally use a local [Ganache](https://github.com/trufflesuite/ganache/tree/develop/packages/ganache#readme) node (including Safe's singleton contracts) for testing purposes:
