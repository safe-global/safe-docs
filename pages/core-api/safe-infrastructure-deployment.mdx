...
Once you have deployed the [Safe\{Core\} contracts](../smart-contracts/smart-account-deployment.mdx), you must deploy the off-chain components of the Safe\{Core\} Stack, including backend and frontend services. 
...
Open `http://YOUR_CONFIG_SERVICE_DOMAIN/admin` to configure your chain(s):
