...
{/* <!-- vale off --> */}
  ...
  <Tabs items={['TypeScript', 'Python', 'Curl']}>
    ...
    <Tabs.Tab>
      ```bash
      curl -X 'POST' \
      'https://api.safe.global/tx-service/11155111/api/v1/safes/0xc62C5cbB964459Fffffffffffffffffffff74b2E/messages/' \
...
{/* <!-- vale off --> */}
  ...
  <Tabs items={['TypeScript', 'Python', 'Curl']}>
    ...
    <Tabs.Tab>
      ```bash
      curl -X 'GET' \
      'https://api.safe.global/tx-service/11155111/api/v1/messages/0xcf2e6b1e26e6930e14bebf120ffffffffffffffffffffb484a787137201ab0df/' \
      -H 'accept: application/json' \
      -H 'Authorization: YOUR_ACCESS_TOKEN' \
      ```
    </Tabs.Tab>
...
{/* <!-- vale off --> */}
  ...
  <Tabs items={['TypeScript', 'Python', 'Curl']}>
    ...
    <Tabs.Tab>
      ```bash
      curl -X 'POST' \
      'https://api.safe.global/tx-service/11155111/api/v1/messages/0xcf2e6b1e26e6930e14bebf120ffffffffffffffffffffb484a787137201ab0df/signatures/' \
      -H 'accept: application/json' \
      -H 'Content-Type: application/json' \
      -H 'Authorization: YOUR_ACCESS_TOKEN' \
      -d '{
