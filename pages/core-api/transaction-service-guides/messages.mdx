...
<Tabs items={['TypeScript', 'Python']}>
  <Tabs.Tab>
    ```typescript import SafeApiKit, {AddMessageOptions} from
  ...
  <Tabs.Tab>
    ...
    eth_account.messages import defunct_hash_message from safe_eth.eth import
    EthereumClient, EthereumNetwork from safe_eth.safe import Safe from
    safe_eth.safe.api.transaction_service_api import TransactionServiceApi ```
  </Tabs.Tab>
</Tabs>
