...
import Mdx from '../../../components/ApiReference/generated/peaq-reference.mdx'
import swagger from '../../../components/ApiReference/schemas/peaq-swagger.json'
