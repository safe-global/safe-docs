...
import Mdx from '../../../components/ApiReference/generated/tempo-reference.mdx'
import swagger from '../../../components/ApiReference/schemas/tempo-swagger.json'
...
<ApiReference networkName="tempo"/>
{/* <!-- vale on --> */}
