...
import Mdx from '../../../components/ApiReference/generated/xdc-reference.mdx'
import swagger from '../../../components/ApiReference/schemas/xdc-swagger.json'
