...
All Safe Infrastructure services have a rate limit of 5 requests per second. For higher limits, see [Pricing & Plans](./api-pricing) and [Quotas & Limits](./api-authentication).
