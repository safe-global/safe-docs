...
Safe's vision is to make every web3 account a smart account. Therefore, we prioritize teams and chains building with smart accounts, especially if they push account abstraction (for example, [ERC-4337](../advanced/erc-4337/4337-safe.mdx) or EIP-1271 adoption) with Safe.
...
You can find detailed instructions under [contracts deployment](../smart-contracts/smart-account-deployment.mdx).
