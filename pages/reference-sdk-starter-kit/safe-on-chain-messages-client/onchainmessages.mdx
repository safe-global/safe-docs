...
We have other extensions that adds the confirmXXX or getPendingXXX methods as well as in the case of the on-chain messages or Safe operations. This is not the case because generating the on-chain is creating a regular transaction. 
