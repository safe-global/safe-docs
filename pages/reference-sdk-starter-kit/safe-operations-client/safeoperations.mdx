...
This methos enables to extend the SafeClient with the ability to use a bundler and a paymaster and to perform [EIP-4337](https://eips.ethereum.org/EIPS/eip-4337) User Operations
...
The URL of the bundler in the chosen provider to bundle User Operations (e.g Pimlico, Alchemy)
