...
The provider used to interact with the blockchain can be an [EIP-1193](https://eips.ethereum.org/EIPS/eip-1193) compatible provider object (e.g., `window.ethereum`), an HTTP URL, or a WebSocket URL.
