...
If you require more signatures, you have to collect those signatures programmatically of with the [Safe Wallet UI](https://app.safe.global/).
...
Please be aware that the CoW Swap's SDKs uses ethers, while Safe's SDKs use viem.
