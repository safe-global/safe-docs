...
<Callout type='warning' emoji='⚠️'>
  You can now integrate passkeys with more transactions and functionalities of
  the Safe ecosystem, however please be aware of certain security
  vulnerabilities when dealing with passkeys. We recommend
  using passkeys only in a development environment, and never to secure 1/1
  Safes as a sole method of authentication. Please always use a combination of
  passkeys and other authentication methods to ensure the security of your
  users' assets.
</Callout>
