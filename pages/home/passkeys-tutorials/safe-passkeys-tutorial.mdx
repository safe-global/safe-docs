...
In `components`, create a file `SafeThemeProvider.tsx`. This file will provide the Safe theme to the app using Material UI:
...
```tsx
// from ../../../examples/passkeys/components/SafeThemeProvider.tsx
```

Finally, create a `public` folder, with four icons: [`safe.svg`](https://github.com/5afe/safe-passkeys-tutorial/blob/main/public/safe.svg), [`github.svg`](https://github.com/5afe/safe-passkeys-tutorial/blob/main/public/github.svg/), [`external-link.svg`](https://github.com/5afe/safe-passkeys-tutorial/blob/main/public/external-link.svg), [`safeLogo.png`](https://github.com/5afe/safe-passkeys-tutorial/blob/main/public/safeLogo.png)
