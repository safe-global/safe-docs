...
2. [Human Approval for agent actions](./human-approval.mdx): The AI Agent proposes transactions, human signers approve and execute the transaction. Very secure, but not the fastest.
