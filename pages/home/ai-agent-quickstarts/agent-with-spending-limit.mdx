...
# Agent with a spending limit for a treasury
...
## Set and use a spending limit for the Agent
...
### Set spending limit for Agent

Now you can set a spending limit to your Agent:
...
### Let the Agent use the spending limit
