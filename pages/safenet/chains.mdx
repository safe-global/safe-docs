...
Safenet connects the liquidity of multiple chains to enable users to spend their assets on any supported chain without the need for traditional bridging.
...
Ethereum mainnet will always be the home chain for Safenet.