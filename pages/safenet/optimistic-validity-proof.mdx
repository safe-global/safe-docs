...
* Only a **challenged settlement is gas-intense and slow**. When a validator challenges the settlement request, the processor has to send a proof of validity ([attestation](./protocol/attestation.mdx)). 
