...
**[Introduction](./introduction.mdx)**: Provides a brief overview of Safenet, its high-level architecture, and the flow of a Safenet transaction. Reading this part will provide an understanding of why Safenet is built. It is recommended to start with this part in the given order. This page is part of the introduction.
...
**[Protocol](./protocol/overview.mdx)**: Describes the smart contracts and their role in the Safenet protocol. Reading this part will provide an understanding of the technical details of Safenet.
