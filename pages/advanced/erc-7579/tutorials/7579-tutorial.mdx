...
Let's say you want to build an app where users can add their friends and family as a backup for your Safe. With the ERC-7579 compatibility, you can use Rhinestone's [Social Recovery module](https://docs.rhinestone.wtf/module-sdk/using-modules/social-recovery) to recover your Safe in case you lose access to it.
...
```shell
pnpm add permissionless viem @rhinestone/module-sdk @safe-global/protocol-kit @svgr/webpack
```
...
This file will enable us to create [Pimlico's client with Rhinestone](https://docs.rhinestone.wtf/module-sdk/account-sdks/permissionless). It will:
...
```css
// from ../../../../examples/erc-7579/app/globals.css
```

To add some icons to the app, we will need to edit the `next.config.mjs` file at the root of the project to load SVG files:

```js
// from ../../../../examples/erc-7579/next.config.mjs
```

Finally, in the `public` folder, add three icons. You can find them in the project's GitHub repository: [`safe.svg`](https://github.com/5afe/safe-7579-tutorial/blob/main/public/safe.svg), [`github.svg`](https://github.com/5afe/safe-7579-tutorial/blob/main/public/github.svg/), and [`external-link.svg`](https://github.com/5afe/safe-7579-tutorial/blob/main/public/external-link.svg).
...
We learned how to deploy an ERC-7579-compatible Safe Smart Account and use an ERC-7579-compatible module, the Social Recovery module from Rhinestone. We hope you enjoyed this tutorial and that the combination of Safe and 7579 will allow you to tap into new functionalities for your decentralized apps.

As a next step, you can add more functionalities to your app using other [ERC-7579-compatible modules](https://docs.rhinestone.wtf/module-sdk). Here are some ideas:

- Create a dead man switch in case your account becomes inactive after a certain amount of time.
- Add multi-factor validation to your Smart Account.
- Designate an owner that can act on your behalf for executing transactions and paying for gas.
