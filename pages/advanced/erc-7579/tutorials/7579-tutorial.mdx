...
Click the **Create Safe** button to initialize Permissionless' client with the private key you stored on `.env.local`. It will deploy an ERC-7579-enabled Safe on its first transaction.
