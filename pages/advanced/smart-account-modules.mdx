...
These are audited Safe Modules built and maintained by the Safe team. The [safe-modules](https://github.com/safe-global/safe-modules) repository contains the collection of the Official Safe Modules. Currently, there are three official Safe Modules:
- 4337 module
- Allowance module
- Passkeys module
