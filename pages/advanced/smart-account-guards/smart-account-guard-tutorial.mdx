...
Explanation:
- **`BaseGuard.sol`**: BaseGuard is an abstract contract that inherits Guard interface and implements ERC-165 interface.
- The Guard interface has two functions which need to be implemented:
