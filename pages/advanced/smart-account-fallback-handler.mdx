...
- Includes additional utility functions:
  ...
  - **encodeMessageDataForSafe:** Encodes messages using the Safe's domain separator and a predefined message type hash.
...
- Enables assigning individual fallback handlers to specific function signatures.
...
- Implements the `validateUserOp` function defined by ERC-4337.
