...
More information on Safe Modules is available [here](smart-account-modules.mdx).

#### Safe Guards

[Safe Guards](/home/glossary#safe-guard) make checks before and after a Safe transaction.

More information on Safe Guards is available [here](smart-account-guards.mdx).
