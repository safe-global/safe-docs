...
<Steps>
  ...
  <Tabs items={['New Safe account', 'Existing Safe account']}>
    <Tabs.Tab>
      ...
      By default `Safe4337Pack` is using  version `0.3.0` of the Safe 4337 Module that is only compatible with Entrypoint v0.7. If you need to use v0.6 then add the `safeModulesVersion` property to the options object with the '0.2.0' value.
      ...
      const safe4337Pack = await Safe4337Pack.init({
        ...
        // safeModulesVersion: '0.2.0', // Defaults to 0.3.0. If you are using the v0.6 of the EntryPoint set the value to '0.2.0'
        options: {
