...
<Steps>
  ...
  You can use also a paymaster to handle the fees, If you choose to use a paymaster, there are two other ways we can initialize the `Safe4337Pack`.

  {/* <!-- vale off --> */}

  <Tabs items={['Using ERC-20 Paymaster', 'Using an verifying Paymaster (Sponsoring)']}>
    <Tabs.Tab>
