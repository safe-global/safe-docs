...
In this guide, you will learn how you can create and use Safe accounts with the [Safe ERC-4337 compatible module](https://github.com/safe-global/safe-modules/tree/main/modules/4337/contracts/Safe4337Module.sol) through the `safe-core-sdk`
...
The 4337 package lives in the `relay-kit` package as we are basically relaying transactions to a bundler.
...
<Tabs items={['new-safe.ts','existing-safe.ts']}>
  <Tabs.Tab>
    ...
    const safe4337Pack = await Safe4337Pack.init({
      ...
      bundlerUrl: `https://api.pimlico.io/v1/${CHAIN_NAME}/rpc?apikey=${PIMLICO_API_KEY}`,
      options: {
