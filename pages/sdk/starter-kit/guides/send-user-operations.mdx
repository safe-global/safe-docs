...
In this guide, you will learn how to create Safe [user operations](../../../home/glossary.mdx#useroperation), sign them, collect the signatures from the different owners, and execute them.
...
<Steps>
  ...
  As this guide is related with ERC-4337 user operations, you need to add the `safeOperations` extension to the `SafeClient` to support this functionality.
