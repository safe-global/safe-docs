...
Use [ts-node](https://github.com/TypeStrong/ts-node) to run a TypeScript file in Node.js.
...
// Initialize signers
const OWNER_1_ADDRESS = '0x...'
const OWNER_1_PRIVATE_KEY = '0x...'

const OWNER_2_ADDRESS = '0x...'
const OWNER_2_PRIVATE_KEY = '0x...'

const OWNER_3_ADDRESS = '0x...'
