...
The `init` method initializes the Protocol Kit instance and connects the Safe account. We have two main ways to initialize the Protocol Kit: you can use an already deployed Safe or deploy a new one.
