...
The `Web3AuthModalPack` can be combined with the [Protocol Kit](../../protocol-kit.md) to connect to a Safe using the `provider` and `signer` of the currently authenticated account.
