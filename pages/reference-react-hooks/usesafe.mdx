...
This is the top-level hook to get safe related information. It returns a set of utilities to interact with the safe and enable to things like connect and disconnect signers, retrieve balances and connected chain.
